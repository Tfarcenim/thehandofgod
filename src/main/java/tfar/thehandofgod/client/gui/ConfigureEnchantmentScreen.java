...
public class ConfigureEnchantmentScreen extends GuiContainer {
    ...
    public ConfigureEnchantmentScreen(ConfigureEnchantmentContainer container) {
        super(container);
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        this.fontRenderer.drawString(/*this.handler.getDisplayName().getUnformattedText()*/"Configure Enchantments", 8, 6, 0x404040);
