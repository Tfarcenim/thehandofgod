...
public class Face {
    ...
    private final Int2ObjectArrayMap<ByteBuffer> cache = new Int2ObjectArrayMap<>();
    ...
    public void render(Tessellator tessellator, float textureOffset) {
        ...
        wr = new BufferBuilder(this.vertices.length * wr.getVertexFormat().getNormalOffset());//.getNextOffset()?
        wr.begin(glDrawingMode, DefaultVertexFormats.POSITION_TEX_COLOR_NORMAL);
